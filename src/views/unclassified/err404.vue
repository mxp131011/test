        ...
        <div class="error-content">
            <el-row :gutter="20">
                <el-col :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
                    <div class="pic-error">
                        <el-image class="pic-error-parent" :src="Img404"></el-image>
                    </div>
                </el-col>
                ...
                <el-col :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
                    <div class="bullshit">
                        ...
                        <RouterLink #default="{ navigate }" custom :to="{ path: '/' }">
...
<script setup>
    ...
    import Img404 from '@/assets/image/error-page/404.svg';
